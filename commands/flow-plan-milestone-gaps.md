...
2. Read `M/requirements.md` — identify all Must Have requirements
3. Read `M/roadmap.md` — understand current phase structure
4. Read all phase handoffs in `M/phases/` — understand what was actually built
...
For each gap phase, append to `M/roadmap.md`:
