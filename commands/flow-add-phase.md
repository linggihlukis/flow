...
1. Confirm `M/roadmap.md` exists → if not: "Run /flow-new-project first"
2. Read `M/roadmap.md` — understand the current phase structure and last phase number
3. Read `M/requirements.md` — check if any unassigned requirements exist
...
Append to `M/roadmap.md` under the current milestone:
